...
def test_pybots_no_pandas():
    ...
    def hit_all_methods(strategy):
        ...
        try: strategy.precalculate_signals(df, mock_context)
        except Exception: pass
        try: strategy.calculate_signals(df, mock_context)
        except Exception: pass
        try: strategy.evaluate(MagicMock())
        except Exception: pass
        try: strategy.on_order_update(MagicMock(), MagicMock())
        except Exception: pass
