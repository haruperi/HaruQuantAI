...
def make_trade(pnl: float, is_open: bool = False, close_time: str = "2026-01-01T00:00:00Z") -> dict[str, Any]:
...
def test_win_after_win_probability():
    ...
    # Total wins that have a following trade: t1 (followed by t2=loss), t3 (followed by t4=win).
    # So 1 out of 2.
