...
from app.services.utils.settings import Settings, validate_config
...
def example_03_live_gates() -> None:
    ...
    cfg_live = _make_settings(live_enabled=True, live_mode="read_only")
...
def example_04_shadow_and_dry_run_execution() -> None:
    ...
    shadow_cfg = _make_settings(live_enabled=True, live_mode="read_only")
    with patch("app.services.live.gates.check_risk_kill_switch", return_value=False):
