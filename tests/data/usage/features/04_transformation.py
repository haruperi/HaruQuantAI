...
def fr_data_081_082_083_085_086() -> None:
    ...
    ds = _sample_m1_dataset()
    frame = to_ohlcv_dataframe(ds)
    print(f"Success -> OHLCV DataFrame(shape={frame.shape})")
    ...
    tick_frame = to_tick_dataframe(tick_ds)
    print(f"Data -> Tick DataFrame(shape={tick_frame.shape})")
