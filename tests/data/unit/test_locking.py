...
import pytest
from app.services.data.contracts import TransactionRequest, TransactionResult
from app.services.data.contracts.errors import DataError
from app.services.data.storage import locking
...
def test_lock_lease_configuration_fails_closed(
    ...
    if value is None:
        monkeypatch.delenv("WRITE_LOCK_LEASE_SECONDS")
    else:
        monkeypatch.setenv("WRITE_LOCK_LEASE_SECONDS", value)
