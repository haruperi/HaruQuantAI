...
def fr_utils_007_generate_id() -> None:
    """FR-UTL-007: Generate a canonical UUID4 request identifier."""
    _header("Example 1: Generate ID")
    print("Generated request ID:", generate_id("req"))


def fr_utils_008_validate_id() -> None:
    """FR-UTL-008: Validate a canonical UUID4 workflow identifier."""
...
def fr_utils_009_derive_stable_id() -> None:
    """FR-UTL-009: Derive a deterministic non-trace artifact identity."""
