...
def main() -> None:
    """Execute the Utils-owned cockpit contract-envelope stages."""
    print(f"{WORKFLOW_ID} — Cockpit Contract Envelope")
    ...
    print("SUCCESS: WF-UTL-008 cockpit contract envelope completed")
