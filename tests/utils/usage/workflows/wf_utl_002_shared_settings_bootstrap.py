"""WF-UTL-002: execute shared settings bootstrap end to end."""
...
from app.utils import ConfigurationError, RuntimeSettings, load_settings
from pydantic import ValidationError as PydanticValidationError

WORKFLOW_ID = "WF-UTL-002"
STAGES = (
...
def main() -> None:
    ...
    try:
        ...
        print("Invalid environment rejected:", exc.code)
    else:
