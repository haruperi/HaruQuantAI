...
Covers ``TC-IMP-BRK-11`` (ordered, deduplicated broker EventEnvelope records)
and ``TC-IMP-BRK-12`` (one reusable adapter conformance suite).
"""
...
# --- TC-IMP-BRK-11: broker EventEnvelope normalization ---
...
# --- TC-IMP-BRK-12: reusable adapter conformance suite ---
