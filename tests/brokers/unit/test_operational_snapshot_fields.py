...
Covers ``feature`` (order/position uncertainty fields), ``feature``
(capability matrix trait extensions), and ``feature`` (safe order command
...
# --- feature: snapshot uncertainty fields ---
...
# --- feature: capability matrix trait extensions ---
