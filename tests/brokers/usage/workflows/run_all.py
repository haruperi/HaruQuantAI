...
WORKFLOWS = (
    "wf_brk_pri_resolve_explicit_adapter.py",
    "wf_brk_sec_connect_authenticate_provider_session.py",
    "wf_brk_003_acquire_provider_market_data.py",
    "wf_brk_ter_submit_one_broker_mutation.py",
    ...
    "wf_brk_010_discover_registered_brokers_capabilities.py",
)
