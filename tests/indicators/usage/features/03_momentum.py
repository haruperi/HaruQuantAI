"""Executable usage evidence for FEAT-INDI-03 momentum indicators."""
...
def fr_indi_021() -> None:
    ...
    print_requirement_evidence("FR-INDI-021", actual_data=values)
...
def fr_indi_022() -> None:
    ...
    print_requirement_evidence("FR-INDI-022", actual_data=values)


def main() -> None:
    """Run every momentum requirement demonstration."""
    _feature_header(
        "FEATURE: FEAT-INDI-03 — momentum/ — Momentum Oscillator Calculation\n\n"
