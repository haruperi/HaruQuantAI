"""Run White Fairy signals against real MT5 market data."""
...
print("\nWHITE FAIRY — REAL MT5 EURUSD M5 SIGNAL")
print("=" * 88)
...
source_hash = hashlib.sha256(
    inspect.getsource(WhiteFairyEvaluator).encode()
).hexdigest()
context = StrategyExecutionContext(
    ...
    request_id="strategy-usage-white-fairy",
    workflow_id="strategy-usage-white-fairy-workflow",
    correlation_id="strategy-usage-white-fairy-correlation",
