/**
 * Usage program 10 — Frontend session and page context (FEAT-API-10).
 *
 ...
 *
 * Run:
 *   cd app/ui && NODE_PATH=./node_modules npx tsx ../../tests/api/usage/10_frontend_context.tsx
 */
...
async function main(): Promise<void> {
  console.log("=== Usage program 10 — Frontend session and page context ===");
