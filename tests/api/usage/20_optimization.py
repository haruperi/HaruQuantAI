"""Standalone optimization API feature usage."""
...
def main() -> None:
    """Verify the optimization feature's routes use canonical contracts."""
    ...
    print({"feature": "optimization", "operations": len(operations)})
