"""Standalone dashboards API feature usage."""
...
def main() -> None:
    """Verify the dashboards feature's routes use canonical contracts."""
    ...
    print({"feature": "dashboards", "operations": len(operations)})
