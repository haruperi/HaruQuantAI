"""Standalone simulation API feature usage."""
...
def main() -> None:
    """Verify the simulation feature's routes use canonical contracts."""
    ...
    print({"feature": "simulation", "operations": len(operations)})
