"""Standalone strategies API feature usage."""
...
def main() -> None:
    """Verify the strategies feature's routes use canonical contracts."""
    ...
    print({"feature": "strategies", "operations": len(operations)})
