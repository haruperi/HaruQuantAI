/**
 * Usage program 11 — Workflow presentation components (FEAT-API-11).
 *
 ...
 *     ../../tests/api/usage/11_frontend_components.tsx
 */
...
async function main(): Promise<void> {
  console.log("=== Usage program 11 — Workflow presentation components ===");
