...
- `manage_data`: (2026-08-27) mock-build slice done (datasets, instruments, sessions, data_quality widgets registered into WidgetRegistry; 7 operations mock-dispatched; de-mock at 4.8/5.8/6.16).
...
- [X] 1.8 `FEAT-UI-MANAGE_DATA` — completable mock build done 2026-08-27 (datasets, instruments, sessions, data_quality; all 7 operations mock-dispatched; de-mock pending 4.8, 5.8, 6.16)
