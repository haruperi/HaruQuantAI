...
class ServiceRegistry:
    ...
    def register[CapT](
        ...
        """Register one provider and return its ownership token."""
    ...
    def register_many(
        ...
        *,
        ...
        """Publish a capability bundle atomically under one registry lock."""
    ...
    def get_binding(self, capability_identifier: str) -> ProviderBinding | None:
        """Return a snapshot reference to the current binding when present."""
        with self._lock:
