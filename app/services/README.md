...
| `Interfaces` | [`app/services/interfaces`](interfaces/README.md) | **B** | 2 | Capability-aware external HTTP/SSE/automation boundary features (D-IFACE) |
...
- **Removability Tier:** `B` (Swappable Provider)
- **Feature Count:** 2 registered features
