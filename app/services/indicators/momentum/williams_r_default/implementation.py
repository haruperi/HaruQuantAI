"""Williams percent-R calculator implementation for indicator.williams_r.default."""
...
def williams_r(
    ...
    *,
    ...
    _unwrap_indicator_response(validate_indicator("williams_r", data, resolved_config))
