...
class IndicatorErrorCode(StrEnum):
    ...
    IND_INVALID_SNAPSHOT = "IND_INVALID_SNAPSHOT"
    IND_INPUT_NOT_CLOSED = "IND_INPUT_NOT_CLOSED"
    IND_STALE_INPUT = "IND_STALE_INPUT"
    IND_INCOMPATIBLE_TIMEFRAME = "IND_INCOMPATIBLE_TIMEFRAME"
