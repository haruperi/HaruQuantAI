...
Implements spec ``IND-PT-06`` under the consolidated Patterns owner. The
formula and registry identity (``engulfing``) are unchanged by the move.
"""
...
def engulfing(
    ...
    *,
    ...
    _unwrap_indicator_response(validate_indicator("engulfing", data, resolved_config))
