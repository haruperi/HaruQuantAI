...
Implements spec ``IND-PT-05`` under the consolidated Patterns owner. The
formula and registry identity (``inside_bar``) are unchanged by the move.
"""
...
def inside_bar(
    ...
    *,
    ...
    _unwrap_indicator_response(validate_indicator("inside_bar", data, resolved_config))
