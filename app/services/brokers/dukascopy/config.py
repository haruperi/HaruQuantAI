"""Strict feature configuration for the Dukascopy provider."""
...
class DukascopyConfig:
    """Trusted Dukascopy sandbox provider configuration."""
    ...
    @classmethod
    def from_dict(cls, values: dict[str, object]) -> "DukascopyConfig":
        """Validate explicit Dukascopy provider configuration."""
