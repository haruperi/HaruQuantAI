"""MetaTrader channel health persistence."""

from app.services.brokers._shared.health import _record_health_checkpoint


def record_metatrader_health_checkpoint(**evidence: object) -> object:
    """Record one redacted MetaTrader health checkpoint.
    ...
    """
    return _record_health_checkpoint("mt5", **evidence)  # type: ignore[arg-type]
