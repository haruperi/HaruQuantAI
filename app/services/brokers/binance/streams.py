...
class _BinancePriceStreamsMixin:
    ...
    async def _open_stream[T](
        ...
        *,
        ...
        Args:
            ...
            symbols: Value supplied to the operation.
            stream_name: Value supplied to the operation.
            stream_kwargs: Value supplied to the operation.
            mapper: Value supplied to the operation.
            initial_event: Value supplied to the operation.
    ...
    async def _pump_stream[T](
        ...
        Args:
            subscription: Value supplied to the operation.
            stream_name: Value supplied to the operation.
            stream_kwargs: Value supplied to the operation.
            mapper: Value supplied to the operation.
