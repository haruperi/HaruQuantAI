...
> **Status:** `Completed` — eleven focused features (`FEAT-BRK-00`..`10`) are implemented with package-root APIs, tests, and numbered usage evidence.
...
| Completed | `FEAT-BRK-02` MetaTrader Direct Broker Channel | `metatrader/` | Direct health, snapshots, streams, calculations, and commands | MetaTrader requirements in Sections 4.3 and 4.10 | `tests/brokers/usage/features/02_metatrader.py` |
