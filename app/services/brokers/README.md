...
| Completed | `FEAT-BRK-17` Simulation Broker Channel | `simulation/` | Exact `sim`/`simulation` factory, socket-free authority injection, canonical lifecycle/finalization, clock-safe authoritative read envelopes, and capability intersection | `FR-BRK-167`–`FR-BRK-172`, `FR-BRK-174`–`181` | `tests/brokers/usage/features/17_simulation.py` |
