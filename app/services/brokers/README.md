...
|---|---|---|---|---|---|
| Completed | `FEAT-BRK-00` Canonical Provider-Neutral Contracts | `contracts/` | Section 4.1 | Section 4.1 requirements | `tests/brokers/usage/00_contracts.py` |
| Completed | `FEAT-BRK-01` Adapter Registry and Capability Discovery | `registry/` | Section 4.8 | Section 4.8 requirements | `tests/brokers/usage/01_registry.py` |
| Completed | `FEAT-BRK-02` MetaTrader 5 Account Lifecycle | `mt5_account/` | Section 4.3 | Section 4.3 requirements | `tests/brokers/usage/02_mt5_account.py` |
| Completed | `FEAT-BRK-03` cTrader Account Lifecycle | `ctrader_session/` | Section 4.4 | Section 4.4 requirements | `tests/brokers/usage/03_ctrader_lifecycle.py` |
| Completed | `FEAT-BRK-04` Binance Lifecycle | `binance_session/` | Section 4.5 | Section 4.5 requirements | `tests/brokers/usage/04_binance_lifecycle.py` |
| Completed | `FEAT-BRK-05` Dukascopy Tick Reads | `dukascopy_ticks/` | Section 4.6 | Section 4.6 requirements | `tests/brokers/usage/05_dukascopy_lifecycle.py` |
| Completed | `FEAT-BRK-06` Yahoo History | `yahoo_history/` | Section 4.7 | Section 4.7 requirements | `tests/brokers/usage/06_yahoo_lifecycle.py` |
| Completed | `FEAT-BRK-07` MetaTrader 5 Mutations | `mt5_mutations/` | Section 4.3 | Section 4.3 requirements | `tests/brokers/usage/07_mt5_mutations.py` |
| Completed | `FEAT-BRK-08` cTrader Mutations | `ctrader_mutations/` | Section 4.4 | Section 4.4 requirements | `tests/brokers/usage/08_ctrader_mutations.py` |
| Completed | `FEAT-BRK-09` Execution History Reads | `execution_history/` | Sections 4.3-4.4 | Sections 4.3-4.4 requirements | `tests/brokers/usage/09_history_reads.py` |
| Completed | `FEAT-BRK-10` Provider Calculations | `provider_calculations/` | Sections 4.3-4.4 | Sections 4.3-4.4 requirements | `tests/brokers/usage/10_calculations.py` |
| Completed | `FEAT-BRK-11` Price Streams | `price_streams/` | Sections 4.4-4.5 | Sections 4.4-4.5 requirements | `tests/brokers/usage/11_price_streams.py` |
| Completed | `FEAT-BRK-12` cTrader Market Data | `ctrader_market_data/` | Section 4.4 | Section 4.4 requirements | `tests/brokers/usage/12_ctrader_market_data.py` |
| Completed | `FEAT-BRK-13` Dukascopy BID Bars | `dukascopy_bars/` | Section 4.6 | Section 4.6 requirements | `tests/brokers/usage/13_dukascopy_bars.py` |
| Completed | `FEAT-BRK-14` Deterministic Fake Adapter | `testing/` | Section 4.9 | Section 4.9 requirements | `tests/brokers/usage/14_fake_adapter.py` |
| Completed | `FEAT-BRK-15` Adapter Runtime | `adapter_runtime/` | Section 4.10 | Runtime and transport-control requirements | `tests/brokers/usage/15_adapter_runtime.py` |
...
| Status | Requirement ID | Responsibility | Class / Function / Method | Side Effects | Raises | Usage / Test |
|---|---|---|---|---|---|---|
| Completed | `FR-BRK-006` | The system shall carry immutable provider/profile, environment, composition-root-derived provider enablement, account reference, resolved in-memory credential mapping, timeout, reconnect, circuit, buffer, and auto-connect configuration without accepting secret references or persisting secrets. | `class BrokerConnectionConfig` | None | `ValueError`: required identity/environment is absent or a numeric limit is invalid. | **Usage:** `tests/brokers/usage/01_registry.py`<br>**Unit:** `tests/brokers/unit/test_models.py::test_connection_config_is_immutable_and_explicit()` |
...
| Completed | `FR-BRK-014` | The system shall expose provider, API/terminal version, endpoint metadata, immutable profile, and environment without secrets. | `class BrokerPlatformInfo` | None | `ValueError`: provider/environment identity is absent. | **Usage:** `tests/brokers/usage/01_registry.py`<br>**Unit:** `tests/brokers/unit/test_models.py::test_platform_info_is_redacted()` |
...
| Completed | `FR-BRK-017` | The system shall represent provider-reported asset/currency balance values with exact decimals and explicit units. | `class BrokerBalance` | None | `ValueError`: asset/unit is absent or mandatory value is invalid. | **Usage:** `tests/brokers/usage/01_registry.py`<br>**Unit:** `tests/brokers/unit/test_models.py::test_balance_uses_decimal_and_unit()` |
...
| Completed | `FR-BRK-028` | The system shall express structural order filters only, without selection policy or unbounded history. | `class BrokerOrderFilter` | None | `ValueError`: date interval is invalid. | **Usage:** `tests/brokers/usage/01_registry.py`<br>**Unit:** `tests/brokers/unit/test_models.py::test_order_filter_is_structural()` |
| Completed | `FR-BRK-029` | The system shall express structural position filters only. | `class BrokerPositionFilter` | None | `ValueError`: supplied filter value is structurally invalid. | **Usage:** `tests/brokers/usage/01_registry.py`<br>**Unit:** `tests/brokers/unit/test_models.py::test_position_filter_is_structural()` |
...
| Completed | `FR-BRK-035` | The system shall distinguish provider validation/preview from final order acceptance. | `class BrokerOrderCheck` | None | `ValueError`: provider check evidence is inconsistent. | **Usage:** `tests/brokers/usage/01_registry.py`<br>**Unit:** `tests/brokers/unit/test_models.py::test_order_check_is_not_acceptance()` |
...
| Completed | `FR-BRK-039` | The system shall carry only fields required for a provider-native margin request. | `class BrokerMarginRequest` | None | `ValueError`: provider-required structural input is absent. | **Usage:** `tests/brokers/usage/01_registry.py`<br>**Unit:** `tests/brokers/unit/test_models.py::test_margin_request_is_provider_native()` |
...
| Completed | `FR-BRK-044` | The system shall define account/platform/state reads independently of mutation capabilities. | `class AccountProvider(Protocol)` | None | None | **Usage:** `tests/brokers/usage/01_registry.py`<br>**Unit:** `tests/brokers/unit/test_protocols.py::test_account_protocol_is_runtime_checkable()` |
| Completed | `FR-BRK-045` | The system shall define only single-target provider mutation primitives. | `class TradeExecutionProvider(Protocol)` | None | None | **Usage:** `tests/brokers/usage/01_registry.py`<br>**Unit:** `tests/brokers/unit/test_protocols.py::test_execution_protocol_excludes_bulk_methods()` |
| Completed | `FR-BRK-046` | The system shall define provider-native calculation requests without local fallback formulas. | `class CalculationProvider(Protocol)` | None | None | **Usage:** `tests/brokers/usage/01_registry.py`<br>**Unit:** `tests/brokers/unit/test_protocols.py::test_calculation_protocol_is_provider_native()` |
| Completed | `FR-BRK-047` | The system shall compose lifecycle and focused capabilities into one async adapter, expose read-only `contract_version="v1"` and `schema_id="brokers.adapter.v1"` properties, support deterministic `async with` cleanup, and expose no sync/strict façade initially. | `class BrokerAdapter(MarketDataProvider, AccountProvider, TradeExecutionProvider, CalculationProvider, Protocol)`; `BrokerAdapter.contract_version -> Literal["v1"]`; `BrokerAdapter.schema_id -> Literal["brokers.adapter.v1"]`; `BrokerAdapter.__aenter__() -> BrokerAdapter`; `BrokerAdapter.__aexit__(exc_type: type[BaseException] | None, exc: BaseException | None, traceback: TracebackType | None) -> None` | External API call; local state mutation | `asyncio.CancelledError`: caller cancels connect/disconnect; consumer exception still propagates after cleanup. | **Usage:** `tests/brokers/usage/01_registry.py`<br>**Unit:** `tests/brokers/unit/test_protocols.py::test_adapter_explicit_connect_and_disconnect()` and `::test_disconnect_is_idempotent()` |
...
| Completed | `FR-BRK-056` | The system shall expose the adapter instance's latest redacted diagnostic error as non-authoritative state. | `async BrokerAdapter.get_last_error() -> StandardResponse[BrokerError | None]` | Read-only | `asyncio.CancelledError`: caller cancels provider diagnostic read. | **Usage:** `tests/brokers/usage/01_registry.py`<br>**Unit:** `tests/brokers/unit/test_protocols.py::test_last_error_is_redacted_and_non_authoritative()` |
...
| Completed | `FR-BRK-094` | The system shall cancel exactly one provider order and transmit the caller request ID where supported. | `async TradeExecutionProvider.cancel_order(order_id: str, client_request_id: str | None = None) -> StandardResponse[BrokerOrderResult]` | Broker mutation | `asyncio.CancelledError`: caller cancels; possible transmission is unknown outcome. | **Usage:** `tests/brokers/usage/01_registry.py`<br>**Unit:** `tests/brokers/unit/test_protocols.py::test_cancel_order_has_one_target()` |
| Completed | `FR-BRK-095` | The system shall modify provider-supported fields on exactly one position. | `async TradeExecutionProvider.modify_position(request: BrokerPositionModificationRequest) -> StandardResponse[BrokerPosition]` | Broker mutation | `asyncio.CancelledError`: caller cancels; possible transmission is unknown outcome. | **Usage:** `tests/brokers/usage/01_registry.py`<br>**Unit:** `tests/brokers/unit/test_protocols.py::test_modify_position_has_one_target()` |
...
| Completed | `FR-BRK-115` | The `adapter_runtime` package initializer shall expose no public symbol and cause no provider import or state mutation. | `adapter_runtime.__init__` | None | None | **Usage:** `tests/brokers/usage/11_price_streams.py` (standalone script, run via `python`)<br>**Unit:** `tests/brokers/unit/test_import_boundaries.py::test_runtime_package_is_private()` |
...
| Completed | `FR-BRK-113` | `contracts/__init__.py` | Export exactly the documented contract symbols after their definitions exist; export no private helper. | `tests/brokers/usage/01_registry.py` | `tests/brokers/unit/test_import_boundaries.py::test_contract_exports_are_exact()` |
...
| Completed | `FR-BRK-118` | `mt5_account/__init__.py` | Export only `MT5BrokerAdapter` and perform no connection or selection. | `tests/brokers/usage/02_mt5_account.py` (standalone script, run via `python`) | `tests/brokers/unit/test_import_boundaries.py::test_mt5_export_is_exact()` |
| Completed | `FR-BRK-119` | `ctrader_session/transport.py` | Own one reactor/socket/authenticated account, enforce documented rate/circuit bounds, and correlate by native request ID or serialize same-response-type requests per session generation. `ctrader/network.py` supplies the default real Spotware sender and verified application/account/trader handshake; callers may inject a sender for deterministic tests. | `tests/brokers/usage/03_ctrader_lifecycle.py` (standalone script, run via `python`) | `tests/brokers/integration/test_ctrader_correlation.py::test_ctrader_correlation_integration_via_root()` |
...
| Completed | `FR-BRK-121` | `ctrader_session/__init__.py` | Export only `CTraderBrokerAdapter`. | `tests/brokers/usage/03_ctrader_lifecycle.py` (standalone script, run via `python`) | `tests/brokers/unit/test_import_boundaries.py::test_ctrader_export_is_exact()` |
...
| Completed | `FR-BRK-124` | `binance_session/mapping.py` | Convert documented Spot payload/native error fixtures to exact canonical units/times/Decimals and reject malformed success. | `tests/brokers/usage/04_binance_lifecycle.py` (standalone script, run via `python`) | `tests/brokers/unit/test_binance_mapping.py::test_binance_mapping_preserves_product_units()` |
| Completed | `FR-BRK-125` | `binance_session/__init__.py` | Export only `BinanceBrokerAdapter`. | `tests/brokers/usage/04_binance_lifecycle.py` (standalone script, run via `python`) | `tests/brokers/unit/test_import_boundaries.py::test_binance_export_is_exact()` |
| Completed | `FR-BRK-126` | `dukascopy_ticks/instruments.py` | Declare exact BI5 symbols and exact interface-specific web-chart mappings demonstrated by provider-response fixtures; `EURUSD` maps to `EUR/USD` only for web-chart calls. | `tests/brokers/usage/05_dukascopy_lifecycle.py`, `13_dukascopy_bars.py` (standalone scripts, run via `python`) | `tests/brokers/unit/test_dukascopy_instruments.py`, `test_dukascopy_candle_transport.py::test_transport_maps_web_symbol_and_paginates_without_duplicates()` |
...
| Completed | `FR-BRK-129` | `dukascopy_ticks/__init__.py` | Export only `DukascopyBrokerAdapter`. | `tests/brokers/usage/05_dukascopy_lifecycle.py` (standalone script, run via `python`) | `tests/brokers/unit/test_import_boundaries.py::test_dukascopy_export_is_exact()` |
...
| Completed | `FR-BRK-132` | `yahoo_history/__init__.py` | Export only `YahooBrokerAdapter`. | `tests/brokers/usage/06_yahoo_lifecycle.py` (standalone script, run via `python`) | `tests/brokers/unit/test_import_boundaries.py::test_yahoo_export_is_exact()` |
| Completed | `FR-BRK-133` | `registry/__init__.py` | Export exactly the three registry functions after catalogue/factory implementation exists. | `tests/brokers/usage/01_registry.py` (standalone script, run via `python`) | `tests/brokers/unit/test_import_boundaries.py::test_registry_exports_are_exact()` |
| Completed | `FR-BRK-134` | `testing/__init__.py` | Export only `FakeBrokerAdapter`; never register it as a provider. | `tests/brokers/usage/01_registry.py` (standalone script, run via `python`) | `tests/brokers/unit/test_import_boundaries.py::test_testing_export_is_exact_and_unregistered()` |
...
- **Support modules (not pytest-collected as tests):** `tests/brokers/response_factory.py`
  ...
  `tests/brokers/usage/_support.py`
