...
from app.services.brokers.ctrader.commands import _CTraderMutationsMixin
from app.services.brokers.ctrader.market_data import _CTraderMarketDataMixin
from app.services.brokers.ctrader.network import _CTraderNetworkClient
from app.services.brokers.ctrader.snapshots import _CTraderExecutionHistoryMixin
from app.services.brokers.ctrader.streams import _CTraderPriceStreamsMixin
...
class CTraderBrokerAdapter(
    ...
    async def _request(
        ...
        Args:
            request_name: Value supplied to the operation.
            response_name: Value supplied to the operation.
            **fields: Value supplied to the operation.
