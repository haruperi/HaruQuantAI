"""Shared explicit lazy broker adapter construction."""
...
_FACTORIES = {
    ...
    BrokerId.CTRADER: _ProviderRegistration(
        "app.services.brokers.ctrader.adapter",
    ...
    BrokerId.BINANCE_SPOT: _ProviderRegistration(
        "app.services.brokers.binance.adapter",
    ...
    BrokerId.DUKASCOPY: _ProviderRegistration(
        "app.services.brokers.dukascopy.adapter",
    ...
    BrokerId.YAHOO: _ProviderRegistration(
        "app.services.brokers.yahoo.adapter",
        "YahooBrokerAdapter",
        "yfinance",
        "yfinance",
        ">=1.4.1",
...
def get_registered_brokers() -> StandardResponse[tuple[BrokerId, ...]]:
    ...
    metadata = build_response_metadata(
        name="brokers.adapter_runtime.get_registered_brokers",
        domain="brokers",
        risk_level="none",
...
def create_broker_adapter(
    ...
    return build_broker_response(
        ...
        name="brokers.adapter_runtime.create_broker_adapter",
        risk_level="low",
        read_only=False,
        requires_network=False,
    )
