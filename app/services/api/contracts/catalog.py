...
_KNOWN_ROUTE_CONTRACTS: tuple[RouteContract, ...] = (
    ...
    _contract(
        ...
        "PUT",
        "/api/v1/settings/credentials/{slot}",
        "api",
        "settings:admin",
        side_effect=RouteSideEffect.WRITE,
    ...
    _contract("api.data.datasets", "GET", "/api/v1/data/datasets", "data", "data:read"),
    _contract(
        "api.data.markets",
        "GET",
        "/api/v1/data/markets",
    ...
    _contract(
        "api.data.depth_stream",
        "GET",
        "/api/v1/data/depth-stream",
        "data",
        "data:read",
        side_effect=RouteSideEffect.STREAM,
        response_contract="StreamEvent.v1",
    ...
    _contract(
        "api.research.automation_batch",
        "GET",
        "/api/v1/research/automation/{batch_id}",
        "research",
        "research:read",
    ),
    _contract(
    ...
    _contract(
        "api.research.transition_expectancy",
        "POST",
        "/api/v1/research/expectancy/{profile_id}/transition",
        "research",
        "research:govern",
        side_effect=RouteSideEffect.GOVERNED_WRITE,
        idempotency_policy="required",
    ...
    _contract(
        "api.simulator.strategies",
        "GET",
        "/api/v1/simulator/strategies",
        "simulator",
        "simulation:read",
        response_contract="BacktestStrategyCatalogue.v1",
    ),
    _contract(
        "api.simulator.start_run",
        "POST",
        ...
        idempotency_policy="required",
        success_statuses=(202,),
        response_contract="BacktestRunProjection.v1",
    ),
    _contract(
        "api.simulator.runs",
        "GET",
    ...
    _contract(
        "api.simulator.run",
        "GET",
        "/api/v1/simulator/runs/{run_id}",
        "simulator",
        "simulation:read",
        response_contract="BacktestRunProjection.v1",
    ),
    _contract(
        "api.simulator.cancel_run",
        "DELETE",
        "/api/v1/simulator/runs/{run_id}",
        "simulator",
        "simulation:run",
    ...
    _contract(
        "api.simulator.run_stream",
        "GET",
        "/api/v1/simulator/runs/{run_id}/stream",
        "simulator",
        "simulation:read",
        side_effect=RouteSideEffect.STREAM,
        response_contract="StreamEvent.v1",
    ...
    _contract(
        ...
        "trading",
        "trading:read",
        response_contract="TradingAccountProfile.v1",
    ),
    _contract(
        ...
        "trading",
        "trading:read",
        response_contract="ExecutionSession.v1[]",
    ),
    _contract(
        "api.trading.create_execution_session",
        "POST",
        "/api/v1/trading/execution-sessions",
        "trading",
        "trading:write",
    ...
    _contract(
        "api.trading.update_execution_session",
        "PATCH",
        "/api/v1/trading/execution-sessions/{session_id}",
        "trading",
        "trading:write",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="optional",
    ...
    _contract(
        "api.trading.default_execution_session",
        "POST",
        "/api/v1/trading/execution-sessions/{session_id}/default",
        "trading",
        "trading:write",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="optional",
    ...
    _contract(
        "api.trading.start_execution_session",
        "POST",
        "/api/v1/trading/execution-sessions/{session_id}/start",
        "trading",
        "trading:write",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="optional",
    ...
    _contract(
        "api.trading.stop_execution_session",
        "POST",
        "/api/v1/trading/execution-sessions/{session_id}/stop",
        "trading",
        "trading:write",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="optional",
    ...
    _contract(
        "api.trading.archive_execution_session",
        "DELETE",
        "/api/v1/trading/execution-sessions/{session_id}",
        "trading",
        "trading:write",
    ...
    _contract(
        "api.trading.execution_session_events",
        "GET",
        "/api/v1/trading/execution-sessions/{session_id}/events",
        "trading",
        "trading:read",
        response_contract="ExecutionSessionEvent.v1[]",
    ),
    _contract(
        "api.trading.complete_execution_session_configuration",
        "POST",
        "/api/v1/trading/execution-sessions/{session_id}/complete-configuration",
        "trading",
        "trading:write",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="optional",
    ...
    _contract(
        "api.trading.execution_session_activity",
        "GET",
        "/api/v1/trading/execution-sessions/{session_id}/activity",
        "trading",
        "trading:read",
        side_effect=RouteSideEffect.STREAM,
        response_contract="StreamEvent.v1",
    ...
    _contract(
        "api.trading.preflight_order",
        "POST",
        "/api/v1/trading/orders/preflight",
        "trading",
        "trading:write",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="required",
    ...
    _contract(
        "api.trading.cancel_order_preflight",
        "POST",
        "/api/v1/trading/orders/{order_id}/preflight",
        "trading",
        "trading:write",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="required",
    ...
    _contract(
        "api.trading.cancel_all_preflight",
        "POST",
        "/api/v1/trading/orders/cancel-all/preflight",
        "trading",
        "trading:write",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="required",
        response_contract="CancelAllPreflightResult.v1",
    ),
    _contract(
        "api.trading.cancel_all_orders",
        "POST",
    ...
    _contract(
        "api.simulation.live_session_restore",
        "POST",
        "/api/v1/simulation/live-sessions/{session_id}/restore",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="optional",
    ...
    _contract(
        "api.simulation.live_session_rearm",
        "POST",
        "/api/v1/simulation/live-sessions/{session_id}/rearm",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="optional",
