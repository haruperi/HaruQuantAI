...
_KNOWN_ROUTE_CONTRACTS: tuple[RouteContract, ...] = (
    ...
    _contract("api.data.series", "GET", "/api/v1/data/series", "data", "data:read"),
    _contract(
    ...
    _contract("api.data.brokers", "GET", "/api/v1/data/brokers", "data", "data:read"),
    _contract(
        "api.data.instrument",
        "GET",
        "/api/v1/data/instruments/{instrument}",
        "data",
        "data:read",
    ),
    _contract(
        "api.data.instrument_update",
        "PATCH",
        "/api/v1/data/instruments/{instrument}",
        "data",
        "data:write",
    ...
    _contract(
        "api.simulator.workbench.live_session_create",
        "POST",
        "/api/v1/simulator/live-sessions",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="required",
        success_statuses=(201,),
        response_contract="LiveSessionProjection.v1",
    ),
    _contract(
        "api.simulator.workbench.live_sessions",
        "GET",
        "/api/v1/simulator/live-sessions",
        "simulator",
        "simulation:read",
    ...
    _contract(
        "api.simulator.workbench.live_session",
        "GET",
        "/api/v1/simulator/live-sessions/{session_id}",
        "simulator",
        "simulation:read",
        response_contract="LiveSessionProjection.v1",
    ),
    _contract(
        "api.simulator.workbench.live_session_viewport",
        "GET",
        "/api/v1/simulator/live-sessions/{session_id}/viewport",
        "simulator",
        "simulation:read",
        response_contract="MarketViewport.v1",
    ),
    _contract(
        "api.simulator.workbench.live_session_step",
        "POST",
        "/api/v1/simulator/live-sessions/{session_id}/step",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="optional",
    ...
    _contract(
        "api.simulator.workbench.live_session_seek",
        "POST",
        "/api/v1/simulator/live-sessions/{session_id}/seek",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="optional",
    ...
    _contract(
        "api.simulator.workbench.live_session_command",
        "POST",
        "/api/v1/simulator/live-sessions/{session_id}/commands",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="required",
        response_contract="CommandReceipt.v1",
    ),
    _contract(
        "api.simulator.workbench.live_session_branch",
        "POST",
        "/api/v1/simulator/live-sessions/{session_id}/branch",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="required",
    ...
    _contract(
        "api.simulator.workbench.live_session_restore",
        "POST",
        "/api/v1/simulator/live-sessions/{session_id}/restore",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="required",
    ...
    _contract(
        "api.simulator.workbench.live_session_rearm",
        "POST",
        "/api/v1/simulator/live-sessions/{session_id}/rearm",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="optional",
    ...
    _contract(
        "api.simulator.workbench.live_session_finalize",
        "POST",
        "/api/v1/simulator/live-sessions/{session_id}/finalize",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="required",
    ...
    _contract(
        "api.simulator.workbench.live_session_reproduce",
        "POST",
        "/api/v1/simulator/live-sessions/{session_id}/reproduce",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="required",
    ...
    _contract(
        "api.simulator.workbench.live_session_close",
        "DELETE",
        "/api/v1/simulator/live-sessions/{session_id}",
        "simulator",
        "simulation:run",
    ...
    _contract(
        "api.simulator.workbench.batch_create",
        "POST",
        "/api/v1/simulator/batches",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="required",
        success_statuses=(202,),
        response_contract="BatchProjection.v1",
    ),
    _contract(
        "api.simulator.workbench.batch",
        "GET",
        "/api/v1/simulator/batches/{batch_id}",
        "simulator",
        "simulation:read",
        response_contract="BatchProjection.v1",
    ),
    _contract(
        "api.simulator.workbench.batch_stream",
        "GET",
        "/api/v1/simulator/batches/{batch_id}/stream",
        "simulator",
        "simulation:read",
        side_effect=RouteSideEffect.STREAM,
        response_contract="StreamEvent.v1",
    ...
    _contract(
        "api.simulator.workbench.batch_cancel",
        "POST",
        "/api/v1/simulator/batches/{batch_id}/cancel",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="required",
    ...
    _contract(
        "api.simulator.workbench.batch_retry_failed",
        "POST",
        "/api/v1/simulator/batches/{batch_id}/retry-failed",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="required",
    ...
    _contract(
        "api.analytics.workbench.runs",
        "GET",
        "/api/v1/analytics/runs",
        "simulator",
        "simulation:read",
        response_contract="RunCatalogueEntry.v1",
    ),
    _contract(
        "api.analytics.workbench.run",
        "GET",
    ...
    _contract(
        "api.analytics.workbench.simulation_result",
        "GET",
        "/api/v1/analytics/runs/{run_id}/simulation-result",
        "simulator",
        "simulation:read",
        response_contract="SimulationResult.v1",
    ),
    _contract(
        "api.analytics.workbench.report",
        "GET",
        "/api/v1/analytics/runs/{run_id}/report",
        "simulator",
        "simulation:read",
        response_contract="PerformanceReport.v1",
    ),
    _contract(
        "api.analytics.workbench.payload",
        "GET",
        "/api/v1/analytics/runs/{run_id}/workbench",
        "simulator",
        "simulation:read",
        response_contract="AnalyticsWorkbenchPayload.v1",
    ),
    _contract(
        "api.analytics.workbench.trades",
        "GET",
        "/api/v1/analytics/runs/{run_id}/trades",
        "simulator",
        "simulation:read",
        response_contract="TradePage.v1",
    ),
    _contract(
        "api.analytics.workbench.trade",
        "GET",
        "/api/v1/analytics/runs/{run_id}/trades/{ticket}",
        "simulator",
        "simulation:read",
        response_contract="ClosedTradeRecord.v1",
    ),
    _contract(
        "api.analytics.workbench.periods",
        "GET",
        "/api/v1/analytics/runs/{run_id}/periods",
        "simulator",
        "simulation:read",
        response_contract="PeriodTable.v1",
    ),
    _contract(
        "api.analytics.workbench.artifacts",
        "GET",
        "/api/v1/analytics/runs/{run_id}/artifacts",
        "simulator",
        "simulation:read",
        response_contract="ArtifactInventory.v1",
    ),
    _contract(
        "api.analytics.workbench.replay_anchors",
        "GET",
        "/api/v1/analytics/runs/{run_id}/replay-anchors",
        "simulator",
        "simulation:read",
        response_contract="ReplayAnchor.v1",
    ),
    _contract(
        "api.analytics.workbench.compare",
        "POST",
        "/api/v1/analytics/compare",
        "simulator",
        "simulation:read",
        response_contract="ComparisonEvidence.v1",
    ),
    _contract(
        "api.analytics.workbench.annotate",
        "POST",
        "/api/v1/analytics/runs/{run_id}/annotations",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="required",
    ...
    _contract(
        "api.analytics.workbench.archive",
        "POST",
        "/api/v1/analytics/runs/{run_id}/archive",
        "simulator",
        "simulation:run",
        side_effect=RouteSideEffect.WRITE,
        idempotency_policy="required",
