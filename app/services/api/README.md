...
| Partial | `FEAT-API-07` Thin HTTP and Streaming Boundaries | `routes/` | Research run and Strategy registration/parameter-update routes; remaining declarations and route contracts planned in Section 4.7 | `FR-API-025` partial; `FR-API-031` completed; remaining Section 4.7 requirements missing | API unit tests and `SYS-WF-003`/`SYS-WF-004` integration tests |
