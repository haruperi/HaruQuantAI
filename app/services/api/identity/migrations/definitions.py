"""Authoritative Identity-owned persistence migration manifest.

Relocated from the retired API-root migration package into its owning Identity
feature; see ``FR-API-073``. The additive normalized authority schema is
``FR-API-074``.
