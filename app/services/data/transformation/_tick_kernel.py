...
def _phase_mask(
    ...
    Args:
        ...
        first_turn: The ``first_turn`` argument.
        second_turn: The ``second_turn`` argument.
        phase_values: The ``phase_values`` argument.
...
def _write_volume_bar(
    ...
    Args:
        bar_index: The ``bar_index`` argument.
        waypoints: The ``waypoints`` argument.
        phases: The ``phases`` argument.
        bar_start_us: The ``bar_start_us`` argument.
        tick_counts: The ``tick_counts`` argument.
        output_offsets: The ``output_offsets`` argument.
        spread_ticks: The ``spread_ticks`` argument.
        bar_milliseconds: The ``bar_milliseconds`` argument.
        output_divisor: The ``output_divisor`` argument.
        timestamps_us: The ``timestamps_us`` argument.
        bids: The ``bids`` argument.
        asks: The ``asks`` argument.
        local_indices: The ``local_indices`` argument.
        output_phases: The ``output_phases`` argument.
        bar_indices: The ``bar_indices`` argument.
    """
