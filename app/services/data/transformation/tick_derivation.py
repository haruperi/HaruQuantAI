...
def _validate_spread_model(
    ...
    Args:
        spread_model: The ``spread_model`` argument.
        fixed_spread_points: The ``fixed_spread_points`` argument.
        min_spread_points: The ``min_spread_points`` argument.
        max_spread_points: The ``max_spread_points`` argument.
...
def _bar_seconds(
    ...
    Args:
        bars: The ``bars`` argument.
        trading_timeframe: The ``trading_timeframe`` argument.
        request_id: The ``request_id`` argument.
...
def _quantum(price_unit_exponent: int) -> Decimal:
    ...
    Args:
        price_unit_exponent: The ``price_unit_exponent`` argument.
...
def _four_tick_offsets(bar_seconds: int) -> tuple[int, int, int, int]:
    ...
    Args:
        bar_seconds: The ``bar_seconds`` argument.
...
def _interpolate(
    ...
    Args:
        start_value: The ``start_value`` argument.
        end_value: The ``end_value`` argument.
...
def _segment_lengths(tick_count: int) -> tuple[int, int, int]:
    ...
    Args:
        tick_count: The ``tick_count`` argument.
...
def _interpolated_price_and_phase(
    ...
    Args:
        ...
        phases: The ``phases`` argument.
        lengths: The ``lengths`` argument.
        local_index: The ``local_index`` argument.
        tick_count: The ``tick_count`` argument.
...
def _spread_increment(
    ...
    Args:
        ...
        spread_model: The ``spread_model`` argument.
        fixed_spread_points: The ``fixed_spread_points`` argument.
        point_value: The ``point_value`` argument.
...
def _build_record(
    ...
    Args:
        ...
        bid: The ``bid`` argument.
        spread_points: The ``spread_points`` argument.
        point_value: The ``point_value`` argument.
        quantum: The ``quantum`` argument.
        local_index: The ``local_index`` argument.
        phase: The ``phase`` argument.
...
def _serialize_rows(generated: MarketDataset) -> list[dict[str, object]]:
    ...
    Args:
        generated: The ``generated`` argument.
...
def _source_chunks(
    ...
    Args:
        dataset: The ``dataset`` argument.
        max_output_rows_per_chunk: The ``max_output_rows_per_chunk`` argument.
