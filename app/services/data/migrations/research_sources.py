...
_STATEMENTS = (
    """
    CREATE TABLE IF NOT EXISTS data_research_sources (
...
_PROVIDER_STATEMENTS = (
    ...
    """.strip(),
    """
    CREATE TABLE IF NOT EXISTS data_research_observations (
    ...
    """.strip(),
    """
    CREATE TABLE IF NOT EXISTS data_verified_research_sources (
        source_id TEXT NOT NULL,
        parser_version TEXT NOT NULL,
