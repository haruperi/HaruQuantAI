...
from app.services.data.sources.research_ingestion import (
    _row_to_document,
)
...
def _persist_record(
    ...
    *,
    ...
    Args:
        ...
        payload_hash: The ``payload_hash`` argument.
        source_id: The ``source_id`` argument.
        source_kind: The ``source_kind`` argument.
        asset_scope: The ``asset_scope`` argument.
        issuer_scope: The ``issuer_scope`` argument.
        macro_series_scope: The ``macro_series_scope`` argument.
        language: The ``language`` argument.
        license_id: The ``license_id`` argument.
        retention_days: The ``retention_days`` argument.
