...
would understate exposure, which is the failure mode risk governance exists to prevent.
"""
    ...
    *,
    ...
    try:
        info, balances, positions, orders, permissions, connected = asyncio.run(
            # Wrapped at the boundary so a mutation call fails here rather than
