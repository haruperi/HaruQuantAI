...
| Completed | `FEAT-SIM-02` Simulation-Owned State              | `state/`      | Exact declarations, historical interactive sessions, and state contracts: Section 4.4a | Section 4.4a requirements including `FR-SIM-251`–`FR-SIM-254` | `tests/simulator/usage/features/02_state.py`; `tests/simulator/unit/test_live_sessions.py` |
