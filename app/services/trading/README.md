...
| Completed | `FEAT-TRD-02` State and Deterministic Projections | `state/`          | Existing state API plus lifecycle/fill operations and authoritative receipt-to-deal-to-position correlation with restart-safe watermarks; exact declarations: Section 4.2 | Section 4.2 functional requirements including `FR-TRD-085`, `FR-TRD-086`, `FR-TRD-101`–`FR-TRD-103` | `tests/trading/usage/features/02_state.py` |
