...
vi.mock("@/widgets/price-ladder", () => ({ PriceLadderWidget: ({ accountId, route, symbol, variant }: { accountId?: string; route?: string; symbol?: string; variant?: string }) => <div data-testid="ladder">{variant}|{accountId}|{route}|{symbol}</div> }));
