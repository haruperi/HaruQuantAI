...
/** Props accepted by `AnalyticsLibrary`. */
            ...
            {runs.map((entry) => (
              <tr key={entry.run_id}>
                ...
                <td className="analytics-library__actions">
                  ...
                  <Link
                    href={`/workstation/analytics/compare?runs=${encodeURIComponent(entry.run_id)}`}
                  >
                    Compare
                  </Link>
                  <Link
                    href={`/workstation/analytics/${encodeURIComponent(entry.run_id)}/artifacts`}
                  >
                    Artifacts
                  </Link>
                  <button
