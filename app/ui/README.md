...
| Completed | `FEAT-UI-02` Markets Widget                           | `src/widgets/markets/`                                                                                   | `MarketsWidget` through the feature barrel                                                                                                                                                                                                             | `FR-UI-030`–`FR-UI-037`; `FR-UI-192`–`FR-UI-193`                                              | `src/widgets/markets/MarketsWidget.test.tsx`                                                                                                                                                                                           |
| Completed | `FEAT-UI-03` Watchlist Widget                         | `src/widgets/watchlists/`                                                                                | `WatchlistWidget` through the feature barrel                                                                                                                                                                                                           | `FR-UI-038`–`FR-UI-045`; `FR-UI-192`                                                             | `src/widgets/watchlists/WatchlistWidget.test.tsx`                                                                                                                                                                                      |
...
| Completed | `FEAT-UI-05` Price Ladder Widget                      | `src/widgets/price-ladder/`                                                                              | `PriceLadderWidget`                                                                                                                                                                                                                                    | `FR-UI-055`–`FR-UI-062`                                                                            | `src/widgets/price-ladder/PriceLadderWidget.test.tsx`; `useDepthStream.test.tsx`                                                                                                                                                     |
| Completed | `FEAT-UI-06` Trading Widget                           | `src/widgets/trading/`                                                                                   | `TradingWidget` through the feature barrel                                                                                                                                                                                                             | `FR-UI-063`–`FR-UI-072`; `FR-UI-147`; `FR-UI-225`–`FR-UI-233`                               | `src/widgets/trading/OrderTicket.test.tsx`; `TradingWidget.test.tsx`; `src/widgets/price-ladder/PriceLadderWidget.test.tsx`; typed client and API contract tests                                                                  |
| Pending   | `FEAT-UI-08` Trade Log Widget                         | Target:`src/widgets/trade-log/`; current: `src/components/workflow/TradeLogWidget.tsx`                 | `TradeLogWidget`                                                                                                                                                                                                                                       | `FR-UI-085`–`FR-UI-089`                                                                            | Pending evidence                                                                                                                                                                                                                          |
| Pending   | `FEAT-UI-09` Positions and Orders Widgets             | Target:`src/widgets/positions/`; current: `src/components/workflow/PositionsWidget.tsx`                | `PositionsWidget`, orders presentation                                                                                                                                                                                                                 | `FR-UI-090`–`FR-UI-098`                                                                            | Pending evidence                                                                                                                                                                                                                          |
| Pending   | `FEAT-UI-10` Trade Plan Widget                        | Target:`src/widgets/trade-plan/`; current: `src/widgets/planning/TradePlanWidget.tsx`                 | `TradePlanWidget`                                                                                                                                                                                                                                      | `FR-UI-099`–`FR-UI-104`                                                                            | Pending evidence                                                                                                                                                                                                                          |
...
| Completed | `FEAT-UI-13` System Settings                          | `src/widgets/system-settings/`                                                                           | `SystemSettingsModal`, `SystemSettingsModalProps`                                                                                                                                                                                                      | `FR-UI-117`–`FR-UI-121`                                                                            | `src/widgets/system-settings/system-settings-modal.test.tsx`                                                                                                                                                                              |
...
| Completed | `FEAT-UI-25` MT5 Market Ticks Diagnostic Widget       | `src/widgets/market-ticks/`                                                                              | `MarketTicksTableWidget`                                                                                                                                                                                                                               | `FR-UI-186`–`FR-UI-191`; `FR-UI-193`                                                             | `src/widgets/market-ticks/MarketTicksTableWidget.test.tsx`, `useMarketSnapshots.test.tsx`                                                                                                                                            |
