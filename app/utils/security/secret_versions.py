...
class SecretVersion:
    ...
    Attributes:
        version: The version identification string.
        value: The secret string payload.
        active: True if this version is the active version.
    """
    ...
    def __post_init__(self) -> None:
        ...
        Raises:
            SecurityError: If the version string or value is invalid or empty.
        """
        if (
