...
def _validate_password(password: str) -> bytes:
    """Validate candidate password type and boundary constraints.

    Args:
        password: The candidate password string.

    Returns:
        The encoded UTF-8 bytes of the password.

    Raises:
        SecurityError: If the password is not a string or exceeds length limits.
    """
