"""Public contract for declaring, inspecting, and validating plugin manifests.

Provides the ``DeclareManifestsCapability`` protocol and versioned metadata
models for manifest parsing, constraint checking, package archive verification,
and bounded compatibility/permission/ownership previews.
"""
