...
**Status:** `ManageWorkspacesCapability` implemented; remaining domain capability surfaces planned.
...
**Capability bundles (6):** `ManageWorkspacesCapability` (implemented), `ConfigureRuntimeCapability`, `SecureLocalAccessCapability`, `BuildDiagnosticsCapability`, `DistributeWorkersCapability`, and `HostWorkspacesCapability`.
