...
└── services/
    └── simulator/                                      # deterministic simulation domain
        ...
        ├── api/
        │   ├── tools.py                                 # run_backtest boundary / authorization / envelopes
        ...
        │   ├── state.py                                 # authoritative in-memory state
        ...
        │   └── borrow.py                                # short borrow/recall (optional)
        ├── controls/
...
docs/simulator/                                           # user guide, config, scope, traceability, runbooks
tests/simulator/                                          # test-only verification suites
examples/run_simulator_examples.py                         # executable usage documentation
```
