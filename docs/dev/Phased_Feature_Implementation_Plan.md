...
Backend feature usage belongs in each feature's required `_usage.py`, through the pipeline's bounded offline executable scenarios. Focused domain-logic modules contain production behavior only. The canonical README supplies the exact runnable command and expected output. It must exercise a useful public operation, a failure/unavailable case and cleanup; it must not depend on a real account, private market files or network availability by default.
...
### - [x] Task 1.06 — FEAT-UI-VIEW_COLLECTIONS — Navigate large typed collections accessibly
...
**Accepted commit:** `task-closeout:20260908-140000-v3-phases-1-16-1.06-view-collections` — reconciled owner, contracts, tests, usage recipe, and evidence manifest.
...
**Accepted commit:** `task-closeout:20260908-203500-v3-phases-1-16-1.12-register-contributions` — reconciled owner, contracts, tests, usage recipe, and evidence manifest.
