...
- `app/services/brokers/` is a completed implementation baseline. The canonical
  ...
  Release remains fail-closed: `registry/catalogue.py` releases only the verified
...
* **Owns**: The 21-indicator formula library, parameter validation, indicator registry and capability matrix. Each approved indicator owns one focused leaf file; retrospective SMC/FVG/swing/BOS/CHoCH labels are excluded from the immutable non-repainting surface.
...
| Completed   | Orders, fills, execution state, idempotency reservations,`TradeRecord` tables                                                                                                                                                     | `Trading`        | `Portfolio`, `UI/API` via `TradeRecord` / `ExecutionReceipt`; Analytics only through a complete versioned closed-trade ledger projection | `Trading` only                                                     | Reconciliation state, incident records, and idempotency reservations included; unreconciled records flagged                                                     |
...
| 4. Indicators | OK | OK | OK | OK | OK | OK | OK | OK | OK | OK | OK | OK | REG `app/services/indicators/README.md:248`; TASK `app/services/indicators/README.md:441`; GATE `app/services/indicators/__init__.py:43`; FUNC `app/services/indicators/__init__.py:43`; DEEP `tests/indicators/unit/test_import_boundaries.py:12`; ROOT `app/services/indicators/__init__.py:1`; USE `tests/indicators/integration/test_usage_scripts.py:1`; WFE `tests/indicators/usage/workflows/run_all.py:1`; UT `tests/indicators/unit/test_public_api.py:1`; IT `tests/indicators/integration/test_batch_calculation.py:1`; COV `tests/indicators/unit/test_persistence_crud.py:1`; HYG `tests/indicators/unit/test_import_boundaries.py:136` |
| 5. Strategy | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | |
| 6. Risk | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | |
| 7. Trading | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | |
| 8. Simulator | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | |
...
| 4. Indicators | OK | OK | ~ | OK | OK | OK | OK | OK | OK | ~ | DB `app/services/indicators/migrations/definitions.py:150`, `app/services/api/composition/lifecycle.py:51`; SCHEMA `docs/schema/05_reconciliation.md:328`; REACH `app/services/indicators/persistence/read.py:1` (bounded divergence: support schema/CRUD applied, feature withdrawn, no production consumer caller yet); CONTRACT `app/services/indicators/README.md:58`, `tests/indicators/unit/test_contracts.py:1`; LOG `app/services/indicators/migrations/definitions.py:159`, `app/services/indicators/core/registry.py:182`; SAFE `app/services/indicators/core/errors.py:1`, `tests/indicators/unit/test_import_boundaries.py:136`; QUANT `tests/indicators/unit/test_zigzag.py:1`, `app/services/indicators/README.md:58`; NFR `tests/indicators/unit/test_concurrency.py:99`, `tests/indicators/unit/test_large_input.py:1`; DOCS `app/services/indicators/README.md:1`, `docs/ARCHITECTURE.md:281`, `docs/CHANGELOG.md:1`; UI `app/services/api/composition/lifecycle.py:51` (D2-B exclusion: Indicators consumed via Strategy/Simulation/Research orchestration, direct UI-API routes deferred) |
| 5. Strategy | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | |
| 6. Risk | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | |
| 7. Trading | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | |
| 8. Simulator | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | |
