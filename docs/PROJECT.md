...
| Missing | `LOG_DIRECTORY`                     | `Path`             | `data/logs`                                   | No          | `Utils`   | All domains                                       | Directory created during explicit configuration for app/access/debug/error logs        |
...
| Missing | `LOG_ENQUEUE`                       | `bool`             | `true`                                        | No          | `Utils`   | All domains                                       | In-process queued logging with explicit non-destructive synchronization and flush/stop lifecycle |
