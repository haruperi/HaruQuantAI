    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                console.error(err)
                setError("Failed to fetch hourly returns and drawdowns data.")
            } finally {
                setLoading(false)
            }
        }
            ...
            <div className="flex flex-col h-full w-full">
                ...
                <div className="flex-1 flex items-center justify-center p-6 bg-muted/10">
                    <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground mt-2">Please select a backtest run to view hourly returns and drawdowns.</p>
                    </div>
                </div>
            </div>
        )
                        ...
                        {loading ? (
                            ...
                            <div className="flex items-center justify-center h-[400px]">
                                <div className="text-center">
                                    ...
                                    <p className="text-sm text-muted-foreground mt-2">No hourly returns and drawdowns data to display.</p>
                                </div>
                            </div>
                        )}
                    </CardContent>
