    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                console.error(err)
                setError("Failed to fetch weekly accumulative net profit data.")
            } finally {
                setLoading(false)
            }
        }
    ...
    if (!selectedBacktest) {
        return (
            <div className="flex flex-col h-full w-full">
                <PerformancePageHeader title="Weekly Accumulative Net Profit" />
                <div className="flex-1 flex items-center justify-center p-6 bg-muted/10">
                    <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground mt-2">Please select a backtest run to view weekly accumulative net profit.</p>
                    </div>
                </div>
            </div>
        )
                        ...
                        {loading ? (
                            ...
                            <div className="flex items-center justify-center h-[400px]">
                                <div className="text-center">
                                    ...
                                    <p className="text-sm text-muted-foreground mt-2">No weekly accumulative profit data to display.</p>
                                </div>
                            </div>
                        )}
                    </CardContent>
