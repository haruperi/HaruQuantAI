...
from app.services.utils.dataframe_tools import OHLCV_COLUMNS, _pandas, dataframe_columns
from app.services.utils.errors import ValidationError
from app.services.utils.logger import logger
from app.services.utils.normalization import normalize_timestamp_sequence
    ...
    *,
    ...
    for issue in issues:
        if issue["code"] == code and issue["column"] == column:
            ...
            logger.info("Implemented adding quality issue")
            return
...
def _numeric_value(value: object) -> float | None:
    ...
    if isinstance(value, bool) or not isinstance(value, int | float):
        logger.info("Implemented converting value to numeric float")
        return None
    logger.info("Implemented converting value to numeric float")
    return float(value)
...
def prepare_ohlcv_data(
    ...
    *,
    ...
    logger.info("Implemented preparing ohlcv data")
    return prepared
...
def inspect_ohlcv_quality(  # noqa: C901, PLR0912, PLR0915
    ...
    *,
    ...
    logger.info("Implemented inspecting ohlcv quality")
    return {
        "passed": passed,
        "quality_score": score,
