...
class NormalizedTradeResult:
    ...
    def __init__(
        ...
        Args:
            retcode: Broker return code for the operation.
            deal: Deal ticket assigned by the broker, if any.
            order: Order ticket assigned by the broker, if any.
            volume: Requested volume.
            price: Execution or request price.
            bid: Current bid price at execution time.
            ask: Current ask price at execution time.
            comment: Broker or service comment string.
            filled_volume: Volume actually filled.
            average_price: Average fill price.
            remaining_volume: Volume left unfilled.
